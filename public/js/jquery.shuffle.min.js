        ...
        i(
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                return (function (t) {
                  for (var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, o = t.threshold, r = t.buffer, l = M(e.width, n, s, o), a = A(i, l, s), u = F(a, r), h = new p(n * u, a[u]), f = a[u] + e.height, c = 0; c < l; c++) i[u + c] = f;
                  return h;
                })({
                  itemSize: t,
          ...
          [
            {
              ...
              value: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                  ...
                  n = b(t, 'width', i),
                  s = b(t, 'height', i);
                e && ((n += b(t, 'marginLeft', i) + b(t, 'marginRight', i)), (s += b(t, 'marginTop', i) + b(t, 'marginBottom', i)));
